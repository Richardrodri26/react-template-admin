...
export const useHandleGridContext: IUseGridHandler = (currentState) => {
    ...
    const addThColumn = (th: ITheadGrid[]) => {
        const currentThead = [...state.thead] as ITheadGrid[]
        const newThead = currentThead.concat(th)
        dispatch({ type: "SET_THEAD", payload: newThead })
    }
    ...
    return {
        ...
        simpleSetFilter, changeAsideColumnValue, intervalSetFilter, setTheadHiddenValue, grouperSetFilter, addThColumn
    }
}